...
{	
	public class ApiAiUnity
	{
		...
		private void StartRecording()
		{
            ...
            if (Microphone.devices.Length > 1) throw new Exception("Multiple Microphones");
            audioSource.clip = Microphone.Start(Microphone.devices[0], true, 20, 16000);
